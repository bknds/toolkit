...
export default class Cropper extends React.Component<ICropperProps, ICropperState> {
  ...
  public fnInit() {
    ...
    Taro.createSelectorQuery().select('.crop-layout').context(res => {

      this._canvasContext = res && res.context || Taro.createCanvasContext('cropCanvas');

      Taro.createSelectorQuery().select('.crop-layout')
    ...
    return (
      <ScrollView className='crop-layout' scrollY={hideBox ? false : true} scroll-top={scrollTop} >
        ...
        <View
          ...
          onTouchStart={(e) => this.fnTouchStart(e)}
          onTouchMove={(e) => this.fnTouchMove(e)}
          onTouchEnd={(e) => this.fnTouchEnd(e)}
          onTouchCancel={(e) => this.fnTouchCancel(e)}
        >
